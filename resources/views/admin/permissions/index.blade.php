              ...
              <table class="table table-hover align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted">{{$permission->display_name}}</td>
                        <td>
                           <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('admin.permissions.edit',$permission->id)}}">ویرایش</a></li>
                                    <li>
                                        <a class="dropdown-item" href="" onclick="destroyItem(event,{{$permission->id}})">حذف</a>
                                        <form class="d-inline" action="{{route('admin.permissions.destroy',$permission)}}" method="POST" id="delete-form-{{$permission->id}}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </li>
